    ...
    try {
        ...
        for (const task of tasksToRemind) {
            try {
                ...
                if (timeLeft > 0)
                    message += `⏳ ${timeLeft} daqiqa qoldi`;
                else if (timeLeft === 0)
                    message += `🔔 Vazifa vaqti keldi!`;
                else
                    message += `⚠️ Vazifa ${Math.abs(timeLeft)} daqiqa kechikdi!`;
...
function parseDateTime(args) {
    ...
    if (parts.length >= 3) {
        ...
        if (['easy', 'medium', 'hard'].includes(lastPart) && /^\d{1,2}:\d{2}$/.test(secondLastPart)) {
            ...
            if (lastPart === 'easy')
                priority = 'LOW';
            else if (lastPart === 'medium')
                priority = 'MEDIUM';
            else if (lastPart === 'hard')
                priority = 'HIGH';
...
bot.command("add", async (ctx) => {
    var _a, _b, _c, _d;
    const args = (_b = (_a = ctx.message) === null || _a === void 0 ? void 0 : _a.text) === null || _b === void 0 ? void 0 : _b.split(' ').slice(1).join(' ');
    if (!args) {
...
Vazifa qo'shish uchun yuqoridagi formatdan foydalaning.`);
    ...
    try {
        const telegramId = (_d = (_c = ctx.from) === null || _c === void 0 ? void 0 : _c.id) === null || _d === void 0 ? void 0 : _d.toString();
        if (!telegramId) {
...
bot.command("tasks", async (ctx) => {
    var _a, _b;
    try {
        const telegramId = (_b = (_a = ctx.from) === null || _a === void 0 ? void 0 : _a.id) === null || _b === void 0 ? void 0 : _b.toString();
        if (!telegramId) {
            await ctx.reply("Xatolik yuz berdi. Qayta urinib ko'ring.");
            return;
        }
...
bot.command("complete", async (ctx) => {
    var _a, _b, _c, _d;
    const args = (_b = (_a = ctx.message) === null || _a === void 0 ? void 0 : _a.text) === null || _b === void 0 ? void 0 : _b.split(' ').slice(1);
    const taskId = args === null || args === void 0 ? void 0 : args[0];
